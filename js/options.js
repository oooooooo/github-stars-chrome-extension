var gh = (function() {
      ...
      getToken: function(interactive, callback) {
        ...
        function setAccessToken(token) {
          ...
          chrome.storage.local.set({'access_token': access_token}, function() {
            if (chrome.runtime.lastError) {
              console.log("storage.local.set access_token error: " + chrome.runtime.lastError);
              return;
            }
  ...
  function interactiveSignIn() {
    ...
    localStorage['client_id']     = document.querySelector('#client-id').value;
    localStorage['client_secret'] = document.querySelector('#client-secret').value;
